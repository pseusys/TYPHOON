...
ALL: list[Protocol] = [
    ...
    Protocol(
        ...
        "Hysteria2+Brutal",
        "udp",
        _img("hysteria2", "client"),
        _img("hysteria2", "server"),
    ),
    Protocol(
        "shadowsocks",
        "Shadowsocks",
        "tcp/udp",
        _img("shadowsocks", "client"),
        _img("shadowsocks", "server"),
    ),
    ...
    Protocol(
        ...
        "VLESS REALITY",
        "tcp",
        _img("vless-reality", "client"),
        _img("vless-reality", "server"),
    ),
    ...
    Protocol(
        ...
        "WireGuard+DAITA",
        "udp",
        _img("wireguard-daita", "client"),
        _img("wireguard-daita", "server"),
    ),
