...
/// Bytes added to the client→server plaintext trailer by full-mode obfuscation.
#[cfg(any(feature = "full_software", feature = "full_hardware"))]
pub(crate) const TRAILER_C2S_OVERHEAD: usize = NONCE_LEN + SYMMETRIC_BUILT_IN_AUTH_LEN + X25519_KEY_LENGTH + ANONYMOUS_NONCE_LEN + NONCE_LENGTH;
