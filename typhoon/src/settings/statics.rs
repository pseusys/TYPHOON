...
pub mod keys {
    ...
    pub const FAKE_BODY_SERVICE_PROBABILITY: Key<f64> = Key::new("TYPHOON_FAKE_BODY_SERVICE_PROBABILITY", 2.0);
    ...
    pub const DECOY_SPARSE_LENGTH_SIGMA: Key<f64> = Key::new("TYPHOON_DECOY_SPARSE_LENGTH_SIGMA", 80.0);
    pub const DECOY_SPARSE_LENGTH_MIN: Key<u64> = Key::new("TYPHOON_DECOY_SPARSE_LENGTH_MIN", 64);
    pub const DECOY_SPARSE_LENGTH_MAX: Key<u64> = Key::new("TYPHOON_DECOY_SPARSE_LENGTH_MAX", 512);
