...
///
/// The flow manager calls [`Self::start`] once at startup, then calls [`Self::process`] for every
/// packet whose trailer decryption or verification failed, and — on the server — for every
