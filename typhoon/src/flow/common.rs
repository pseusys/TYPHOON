...
pub trait FlowManager {
    ...
    fn send_packet(&self, packet: ByteBuffer, generated: bool) -> impl Future<Output = Result<(), FlowControllerError>> + Send;

    /// Receive a packet from the flow manager.
    fn receive_packet(&self, packet: ByteBuffer) -> impl Future<Output = Result<ByteBuffer, FlowControllerError>> + Send;
}
