...
async fn test_client_build_fails_with_no_addresses() {
    ...
    let result = ClientSocketBuilder::<StaticByteBuffer, DefaultExecutor, DefaultClientConnectionHandler>::new(cert, DefaultClientConnectionHandler).with_settings(settings).build().await;
...
async fn test_client_build_fails_with_address_not_in_cert() {
    ...
    let result = ClientSocketBuilder::<StaticByteBuffer, DefaultExecutor, DefaultClientConnectionHandler>::new(cert, DefaultClientConnectionHandler)
